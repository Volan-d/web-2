            ...
            <div class="col-4">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="InputPassword" pattern="((?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,})" required>
                        <!--
                         ((?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,})
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="InputAge" min="1" max="150" required>
                    </div>
